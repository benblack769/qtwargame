...
#ifdef Debug_Macro_Move
struct macro_debug_info{
    vector<vector<vector<TBVals>>> probvals[2];//probs=0,vals=1
};
...
public:
    ...
    vector<vector<TBVals>> ProbsInit();
    vector<RangeArray<double>> GetInteractingPaths();
